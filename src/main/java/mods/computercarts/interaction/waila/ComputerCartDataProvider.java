...
public class ComputerCartDataProvider implements IWailaEntityProvider {
    ...
    public List<String> getWailaHead(Entity entity, List<String> currenttip,
        ...
        currenttip.set(0, color + StatCollector.translateToLocal("entity.computercarts.computercart.name") + " " + stier);
        return currenttip;
    }
    ...
    public List<String> getWailaBody(Entity entity, List<String> currenttip,
        ...
        if (config.getConfig("oc.address") && tag.hasKey("address")) {
            String loc = StatCollector.translateToLocal("tooltip." + ComputerCarts.MODID + ".address");
        ...
        if (config.getConfig("oc.energy") && tag.hasKey("energy") && tag.hasKey("maxenergy")) {
            String loc = StatCollector.translateToLocal("tooltip." + ComputerCarts.MODID + ".storedenergy");
    ...
    public NBTTagCompound getNBTData(EntityPlayerMP player, Entity ent, NBTTagCompound tag, World world) {
        ...
        if (ent instanceof EntityComputerCart) {
            EntityComputerCart cart = (EntityComputerCart) ent;
